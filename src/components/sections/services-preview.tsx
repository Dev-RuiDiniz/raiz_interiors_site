          ...
          >
            ...
            <div className="mt-6">
              <ArtisticText
                ...
                highlightClassName="text-stone-400"
              >
            ...
            >
              <Link
                href="/services"
                className="inline-flex items-center gap-3 font-inter text-xs tracking-[0.2em] uppercase text-white/70 hover:text-white transition-colors group"
              >
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                >
                  ...
                  <ArrowRight
                    size={20}
                    className="text-white/30 group-hover:text-white transform group-hover:translate-x-2 transition-all"
                  />
                </Link>
              </motion.div>
            ))}
